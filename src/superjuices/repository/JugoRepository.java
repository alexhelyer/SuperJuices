...
public class JugoRepository {
    ...
    public static JugoData getAleatorio() throws SQLException {
        
        PreparedStatement st = DBManager.myQuery(" SELECT * FROM jugos ORDER BY RAND() LIMIT 1; ");
